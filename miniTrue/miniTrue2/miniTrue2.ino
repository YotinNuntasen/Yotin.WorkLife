...
void setup() {
  ...
  myPrint("WiFi connecting... Please");
 ...
 attachInterrupt(digitalPinToInterrupt(SW_PIN), SW_Press, HIGH);
...
void loop() {
  ...
  if (SW_Flag) {
    ...
    String humidityStatus = classifyHumidity(h);
    String tempStatus = classifyTemperature(t);
    String pressureStatus = classifyPressure(p);

    String displayMessage;
    if (digitalRead(SW_PIN) == LOW) { // Button pressed (assuming active-low)
      displayMessage = "Humidity: " + humidityStatus + "%" + "\n====================" + "\nTemp: " + tempStatus + "C" + "\n====================" + "\nPressure: " + pressureStatus + " hPa";
    } else {
...
void sendData(float h, float t, float p) {
  ...
  client.setTimeout(50000);  // Wait up to 10 seconds for a response
  ...
  //     String dhtReadings_first = "Humidity: " + humidityStatus + "%" + "\n====================" + "\nTemp: " + tempStatus + "C" + "\n====================" + "\npressure: " + pressureStatus + " hPa";
  //     display.println(dhtReadings_first);
  //     Serial.println(dhtReadings_first);
  // } else{
  //     String dhtReadings_second = "Humidity: " + String(h) + "%" + "\n====================" + "\nTemp: " + String(t) + "C" + "\n====================" + "\npressure: " + String(p) + " hPa";
  //     display.println(dhtReadings_second);
  //     Serial.println(dhtReadings_second);
  // }
  // SW_Flag = false;
  // }
}
